...
/**
 * Active/Paused slider for a recurring entry (renewal template). Pausing stops
 * further drafts from being generated. Optimistic: flips immediately, reverts
 * on failure.
 */
  ...
  async function toggle() {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        toast.error(data.error ?? "Failed to update recurring entry");
        return;
      }
